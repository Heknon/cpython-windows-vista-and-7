...
tests run for x86 and x64. The package pins the complete Windows SDK 10.0.10240
app-local UCRT payload, desktop VC141 runtime, and third-party validation wheels
by SHA-256.
